...
<header>
    ...
    <form method="POST" action="../src/controlers/ajouter_vehicule.php">
        ...
        <select name="id_marque" requiered>
        <?php
        ...
        <select name="id_modele" requiered>
             <?php
            ...
            ?>
                 <h2>Résultat de l'ajout du véhicule</h2>
                 <p><?php echo $message; ?></p>
                  <a href="../recherche.php">Retour à la page principale</a>
        </select><br><br> 
         ...
         <?php
            ...
            while ($resultat = mysqli_fetch_array($requete)) {
                ...
                echo "<tr class='" . $classe . "'>
                        <td><img src='" . $cheminImage . "' alt='Image du modèle'></td>
                        <td>" . $resultat["marque"] . "</td>
                        <td>" . $resultat["modele"] . "</td>
                        <td>" . $resultat["immatriculation"] . "</td>
                        <td>" . $resultat["compteur"] . " Km</td>
                        <td><a class='delete-button' href=../src/controlers/supprimer_vehicule.php?supprimer_vehicule=" . $resultat["id_voiture"] . "class='delete-button'>Supprimer</a></td>
                      </tr>";
            ...
            echo "</table></div>";
             ...
             if (isset($_SESSION['vehicule_supprimee'])) {
                echo "<script>alert('Le vehicule a été supprimée avec succès.');</script>";
                unset($_SESSION['véhicule_supprimee']);
             }
         ?>
